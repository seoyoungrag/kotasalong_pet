...
@Entity
@Table(name="res_hospinfo_detail")
public class ResHospDetailVO implements Serializable {
	/**
	 * 
	 */
	...
	@Column(name="Hosp_Detail_INSERT_DT")
    @Temporal(TemporalType.TIMESTAMP)
	private Date insertDt;
    @Temporal(TemporalType.TIMESTAMP)
	@Column(name="Hosp_Detail_UPDATE_DT")
	...
	public String toString() {
		return "ResHospDetailVO [no=" + no + ", lunchSat=" + lunchSat + ", lunchWeek=" + lunchWeek + ", noTrmtHoli="
