...
@Entity
@Table(name="res_kt_address_info_pharm")
public class ResKTAddressPharmVO implements Serializable {
	/**
	 * 
	 */
	...
	@Column(name="PHARM_KT_ADDRESS_INSERT_DT")
    @Temporal(TemporalType.TIMESTAMP)
	private Date insertDt;
    @Temporal(TemporalType.TIMESTAMP)
	@Column(name="PHARM_KT_ADDRESS_UPDATE_DT")
    private Date updateDt;
    
	/**
	 * 
	 */
	public ResKTAddressPharmVO() {
		super();
	}
	/**
	 * @param no
	 ...
	 * @param updateDt
	 */
	public ResKTAddressPharmVO(int no, String mainNum, String addrRoadNm, String upNm, String addrNm, String pubNm,
			Date insertDt, Date updateDt) {
		super();
		this.no = no;
	...
	public ResKTAddressPharmVO(ResKTAddressClinicVO vo) {
		super();
		this.no = vo.getNo();
		this.mainNum = vo.getMainNum();
		this.addrRoadNm = vo.getAddrRoadNm();
		this.upNm = vo.getUpNm();
		this.addrNm = vo.getAddrNm();
		this.pubNm = vo.getPubNm();
	}
	/**
	 * @return the no
	 */
