...
@Entity
@Table(name="res_animal_pharmacy_edited")
public class ResAnimalPharmacyEditedVO  implements Serializable {
	/**
	 * 
	 */
	public static final long serialVersionUID = 3950956483138873405L;
	@Id
	@Column(name="NO")
	@SerializedName("NO")
	public int no = 0;
    ...
    @Transient
    public ResPharmInfoVO pharmInfo;
    @Transient
    public ResPharmDetailVO pharmDetail;
    @Transient
    public ResKTAddressPharmVO ktInfo;
    @PrePersist
